...
/*
   ...
   #define  GTP_INT_IRQ  IRQ_EINT(1)//
   #define  GTP_INT_PORT S5PV210_GPH0(0) 
#elif defined(CONFIG_OK210_BOARD_V1)||defined(CONFIG_OK210_BOARD_V3)
   #define  GTP_INT_IRQ IRQ_EINT(27)//
   #define  GTP_INT_PORT S5PV210_GPH0(27) 
#endif

*/
#define GPIO_TO_PIN(bank, gpio) (32 * (bank - 1) + (gpio))

#define GTP_INT_PORT GPIO_TO_PIN(5,1)
#define GTP_RST_PORT GPIO_TO_PIN(5,0)
